...
def discover_golden_fixtures(repo_root: Path) -> list[dict[str, str]]:
    """Return available golden input paths under pm_sample_inputs."""
    samples = repo_root / "pm_sample_inputs"
